...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN] = LAYOUT(
    ...
    T_MUTE,             _______, RGB_HUD, RGB_HUI, _______, _______, _______,     _______, _______, _______, _______, KC_PSCR, _______, _______, _______,
    RGB_MOD,            _______, RGB_SAD, RGB_SAI, _______, _______, _______,     KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,          _______,
    KC_VOLU,            _______, RGB_VAD, RGB_VAI, _______, _______, _______,     _______, _______, _______, _______, _______, _______, QK_BOOT,
